...
No unnecessary documentation or markdown files or reports for your actions.
...
Create the "docs/DOC.md" file and populate it with relevant information and update it periodically as the project evolves.
