...
- **frontend-service** : Interface web React avec Material-UI
...
Pour plus de détails, consultez [nilm-cnn-service/README.md](nilm-cnn-service/README.md).
...
├── nilm-cnn-service/            # Service NILM CNN (détection IA)
│   ├── src/
...
│   └── README.md               # Documentation NILM-CNN
...
- **[nilm-cnn-service/README.md](nilm-cnn-service/README.md)** : Documentation technique NILM-CNN
- **[.env.example](.env.example)** : Configuration complète avec toutes les variables

## 🤝 Contribution

Ce projet utilise :
- Python 3.13 (sync) et 3.12 (CNN) avec uv pour les dépendances
- TensorFlow/Keras pour les réseaux de neurones CNN
